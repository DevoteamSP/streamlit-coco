...
**Related:** [README quickstart](../../README.md) · [PRD §8](../PRD.md) · Docker / SPCS (P2, not yet documented)
...
- **Docker / Kubernetes / SPCS** — documented in a follow-up (roadmap P2).

For production topologies, see [`docs/roadmap.md`](../roadmap.md).
